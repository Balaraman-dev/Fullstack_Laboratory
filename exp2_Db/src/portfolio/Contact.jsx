    ...
    <div className='w-full flex'>
      ...
      <p>For Booking :</p>
        <form className='flex flex-col w-4/6 gap-4'>
            ...
            />
            <textarea className='bg-white text-black rounded-xl px-2'
              name="message"
              id="message"
            ...
            ></textarea>
            <button className="bg-blue-700 py-1 rounded-xl" onClick={HandleSubmit}>
              Submit
            </button>
          </form>
