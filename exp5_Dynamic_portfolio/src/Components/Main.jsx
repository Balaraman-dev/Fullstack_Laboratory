...
import LoadPortfolio from './portfolio/Main.jsx';
  ...
  <div>         
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/portfolio' element={<Port user={user}/>}/>
        <Route path='/loadportfolio' element={<LoadPortfolio user={user} setUser={setUser}/>}/>
