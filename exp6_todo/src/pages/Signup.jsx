...
export default function Signup() {
  ...
  return (
    ...
    <form className='w-1/4 bg-black py-16 px-8 flex flex-col rounded-xl mt-32' onSubmit={submit}>
      <h2 className='text-white text-2xl text-center mb-4 font-semibold'>Signup</h2>
      ...
      <button className='bg-blue-900 text-white py-2 rounded-2xl hover:bg-white hover:text-black  duration-300 text-xl'>Signup</button>
    </form>
    </div>
  );
}
